        ...
        <div className="p-7 h-screen flex flex-col justify-between">
            <div>
                ...
                <form onSubmit={submitHandler}>
                    <h3 className="text-base mb-2">What is our Caption's Name</h3>
                    ...
                    <h3 className="text-base mb-2">What is our Caption's Email</h3>
                    <input
                        type="email"
                ...
                <p className="text-center">
                    ...
                    <Link className="text-blue-600" to="/Caption_login">
                        Login Here
                    </Link>
                </p>
            </div>
